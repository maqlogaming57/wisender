...
$("select[name='message_type']").on('change', function () {
  ...
  switch (value) {
    ...
    case 'textbill':
      html +=
        '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" rows="20" class="form-control" required>Assalamu\'alaikum Wr. Wb.\nYth. Bapak/Ibu {name},\n\nKami dari PT BPRS Hikmah Bahari menginformasikan bahwa tagihan pembiayaan Bapak/Ibu sebesar Rp {billing} akan jatuh tempo pada tanggal {tgljt}.\n\nKami himbau pembayaran dilakukan dengan tepat waktu. Melalui setor tunai ke cabang terdekat atau via trasnfer ke:\n\nVirtual Account Danamon Syariah Norek: 802300{nodep}\nBSI a.n PT BPRS Hikmah Bahari : 1031323505\n\nJika Bapak/Ibu memiliki pertanyaan atau membutuhkan bantuan lebih lanjut, silakan menghubungi layanan pelanggan kami di whatsapp https://wa.me/6281392101502 \n\nJika sudah melakukan pembayaran abaikan pesan ini.\n\nWassalamu\'alaikum Wr. Wb.\n</textarea></div></div>';
      break;
    case 'textbaghas':
      html +=
    ...
    case 'textbirthday':
      html +=
        '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" rows="20" class="form-control" required>Assalamu\'alaikum Wr. Wb.\nYth.  Bapak/Ibu {name},\n\nPT BPRS Hikmah Bahari mengucapkan Barakallah fii umrik ke {age}.  Semoga Allah melimpahkan keberkahan atas bertambahnya usia.\n\nWassalamu\'alaikum Wr. Wb.\n </textarea></div></div>';
      break;
    case 'media':
      html +=
