...
$("select[name='message_type']").on('change', function () {
  ...
  switch (value) {
    case 'text':
      html +=
        '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" rows="6" class="form-control" placeholder="Example : {{Hai|Hello}} {name}, your number is {number} registered at" required></textarea></div></div>';
      break;
    case 'media':
      html +=
